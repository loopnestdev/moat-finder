...
const ROLE_COLOURS: Record<string, 'green' | 'yellow' | 'red' | 'blue' | 'default'> = {
  admin: 'blue',
  approved: 'green',
  pending: 'yellow',
  rejected: 'red',
...
function AuditTab() {
  ...
  const handleExportCsv = () => {
    ...
    const headers = ['timestamp', 'action', 'ticker', 'user_id', 'ip', 'user_agent'];
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-3">
        {data && (
          <p className="text-sm text-gray-500">{data.count} total records</p>
        )}
